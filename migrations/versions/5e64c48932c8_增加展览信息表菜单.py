...
def upgrade() -> None:
    ...
    insert_stmt = insert(menu_table).values(
        ...
        order_num=1,
        path='exbition',
        component='exb_museum/exbition/index',
        is_frame=1,
        is_cache=0,
        menu_type='C',
        visible='0',
        status='0',
        perms='exb_museum:exbition:list',
        icon='education',
        create_by='admin',
    ...
    insert_stmt = insert(menu_table).values(
        ...
        visible='0',
        status='0',
        perms='exb_museum:exbition:query',
        icon='#',
        create_by='admin',
        create_time=sa.func.sysdate(),
        update_by='',
    ...
    insert_stmt = insert(menu_table).values(
        ...
        visible='0',
        status='0',
        perms='exb_museum:exbition:edit',
        icon='#',
        create_by='admin',
        create_time=sa.func.sysdate(),
        update_by='',
    ...
    insert_stmt = insert(menu_table).values(
        ...
        visible='0',
        status='0',
        perms='exb_museum:exbition:remove',
        icon='#',
        create_by='admin',
        create_time=sa.func.sysdate(),
        update_by='',
    ...
    insert_stmt = insert(menu_table).values(
        ...
        visible='0',
        status='0',
        perms='exb_museum:exbition:export',
        icon='#',
        create_by='admin',
        create_time=sa.func.sysdate(),
        update_by='',
    ...
    insert_stmt = insert(menu_table).values(
        ...
        visible='0',
        status='0',
        perms='exb_museum:exbition:import',
        icon='#',
        create_by='admin',
        create_time=sa.func.sysdate(),
        update_by='',
